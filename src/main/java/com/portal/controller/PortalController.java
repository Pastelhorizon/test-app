...
public class PortalController {
	...
	@RequestMapping(path = "/getrisk", method = RequestMethod.GET)
	...
	@RequestMapping(path = "/postrisk", method = RequestMethod.POST)
	...
	@RequestMapping(path = "/getrealestate", method = RequestMethod.GET)
	...
	@RequestMapping(path = "/postrealestate", method = RequestMethod.POST)
	...
	@RequestMapping(path = "/getdeposit", method = RequestMethod.GET)
	...
	@RequestMapping(path = "/postdeposit", method = RequestMethod.POST)
