...
<body class="bg-light" onload="myFunction()">
	...
	<div class="container">
		...
		<form name="loginform" method="post" action="login"
			...
			<div class="form-group ">
				...
				<label for="uid"><b>Enter User ID</b></label> <input type="text"
					placeholder="Enter UserId" name="userid" class="form-control"
					required> <br> <label for="psw"><b>Enter
						Your Password</b></label> <input type="password" placeholder="Enter Password"
					name="upassword" class="form-control" required>
			</div>
			<button type="submit" class="btn btn-success btn-block text-white">LOGIN</button>
		</form>
	...
	<div class="container">
		<nav class="navbar navbar-dark bg-dark fixed-bottom">
			<div class="container">
				<a href="#" class="navbar-brand">COLLATERAL
